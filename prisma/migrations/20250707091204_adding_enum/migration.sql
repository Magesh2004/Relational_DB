...
*/
-- CreateEnum
CREATE TYPE "PaymentStatuses" AS ENUM ('PAID', 'UNPAID');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'ORDERED', 'DELEVERD');

-- AlterTable
ALTER TABLE "Order" DROP COLUMN "paymentStatus",
ADD COLUMN     "paymentStatus" "PaymentStatuses" NOT NULL DEFAULT 'UNPAID',
DROP COLUMN "status",
